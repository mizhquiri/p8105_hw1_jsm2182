...
In *penguins* there are 8 variables: species, island, bill_length_mm, bill_depth_mm, flipper_length_mm, body_mass_g, sex and year. In species, for example, the most common species is Adelie followed by Gentoo. About 47% are female (not including 11 missing values).
...
The number of columns in *penguins* is 8. The number of rows is 344 (343 observations).
...
I will now create a scatterplot by of bill length and flipper length by species. 
```{r}
